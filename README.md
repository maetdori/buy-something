...
<img src = "getUserInfo.jpg" width="600px" /> 
...
<img src = "getSelection.jpg" width="450px" />                

<br />

### Make Payment          
클라이언트가 "/order/pay"를 요청하면 OrderController는 MakePaymentService를 통해 결제요청을 처리합니다.                          

<img src = "makePayment.jpeg" width="800px" />                       

<br />

# 테이블 구조

<img src = "buy-something ERD.png" width="1000px"/>                   
...
| 1 | ID | id | INT | 11 | NOTNULL | PK | AUTO_INCREMENT |
| 2 | 사용자ID | user_id | INT | 11 | NOTNULL | FK | | 
| 3 | 결제일자 | purchase_date | DATETIME | | NOTNULL | | |
| 4 | 환불여부 | refunded | TINYINT | 4 | NOTNULL | | 0 |
